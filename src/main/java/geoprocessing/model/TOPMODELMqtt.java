...
public class TOPMODELMqtt extends AbstractModelWrapper{
	...
	protected boolean performStep() {
		...
		Calendar preciCalendar = (Calendar) groupData.get("Time");
		...
		Calendar etCalendar = (Calendar) etgroupData.get("Time");
	...
	protected TypedProcessDescription createDescription() {
		return new TopmodelMqttDescriptionGenerator().createDescription();
	}
